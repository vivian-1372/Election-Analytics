---
title: Analzying 2018 and 2020 House Vote Shares
...
Swing state map extension. Instead of plotting voteshare-margin maps for each year y where the
color for a state is colored, plot a swing map for each year where each state is colored by the quantity RyDy+Ry−Ry−4Dy−4+Ry−4. Which states are/have been battleground states? Which are no longer?
...
To answer this question, I pulled data about the House party vote shares for 2016, 2018, and 2020. I show 2018-2016 and 2020-2018 comparison maps, which consist of states colored by the quantity $\frac{D_{y}}{D_{y} + R_{y}} - \frac{D_{y - 2}}{D_{y - 2} + R_{y - 2}}$. This quantity is a measure of state swing in Democratic Party vote share for that House election, since the previous one. Below is the 2018-2016 swing map - negative (red) values show a decline in (D) House vote share in a given state since 2016, positive (blue) values show the opposite, and near-zero (white) values represent no change in (D) House vote. 
...
My analysis confirms that the House elections of the 2018 midterms followed the traditional pattern of the president's party performing rather poorly -- With the exception of Connecticut, Hawaii, Massachusetts, Vermont, and Wyoming, the Democrats gained vote share in every state in comparison to the 2016 House elections. This pattern has been upheld at an incredibly high rate throughout the 20th and 21st century, and it is expected to hold in this year's midterm elections.

However, this swing against the incumbent party may reverse by the next House elections, and this was indeed true in 2020. Unlike the previous swing comparison, the 2020-2018 comparison reveals that most states saw a decline in (D) party vote share in the House elections of 2020. This is especially striking because the Democrats clinched the presidency by a decent margin whilst losing vote share in nearly state House election.
...
[1] Campbell, J. (2018a). Introduction: Forecasting the 2018 US Midterm Elections. PS: Political Science & Politics, 51(S1), 1-3. doi:10.1017/S1049096518001592