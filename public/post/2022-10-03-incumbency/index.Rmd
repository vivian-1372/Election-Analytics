...
```
Below are the expert ratings for the 2018 midterms, which I call predictions because the ratings reflect what the experts believed would happen in each congressional district election. Red areas represent high 
...
## My New Forecast
Below are my models' predictions for the 94 congressional districts where the expert ratings were available.

```{r forecast printout, include = TRUE}
